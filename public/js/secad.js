...
// Alterna entre as duas seções (sidebar): Concessionários Renovação × Comunicados.
function mostrarView(view) {
  ...
  document.getElementById('dp-page-title').textContent = ehCom ? 'Comunicados' : 'Concessionários Renovação';
